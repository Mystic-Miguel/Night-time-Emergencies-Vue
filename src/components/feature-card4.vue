<template>
  <div class="featuresCard feature-card4-feature-card"
    ><svg viewBox="0 0 1024 1024" class="featuresIcon">
      ...
      ></path></svg
    ><div class="feature-card4-container"
      ><h3 class="feature-card4-text heading3">{{ heading }}</h3
      ><span class="bodySmall">{{ subHeading }}</span></div
    ></div
  >
</template>
